...
{
    // vincula o contato adicionado ao campo contato primario
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            if (context.InputParameters.Contains("Target") && context.InputParameters["Target"] is Entity)
            {
                ...
                if (entidadeContexto.LogicalName == "account") // verifica se a entidade do contexto é account
                {
                    ...
                    {  // verifica se contém o atributo telephone1
                       // variável para herdar o conteúdo do atributo telephonel do contexto
